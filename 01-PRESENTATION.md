...
- Analyse les gaps défensifs avec un LLM local (qwen3.5:9b)
...
- **Dashboard SPA vanilla JS** — 28 modules, 0 dépendance NPM
...
- **JARVIS** — Flask + Ollama (qwen3.5:9b) — boucle autonome
