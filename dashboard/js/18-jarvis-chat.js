...
function _ttsFlush(){
  ...
  .then(function(buf){
    ...
    if(!ctx){
      ...
      var a    = new Audio(url);
      a.onended = function(){ URL.revokeObjectURL(url); _ttsRelease(); _ttsFlush(); };
      a.onerror = function(){ URL.revokeObjectURL(url); _ttsRelease(); _ttsFlush(); };
      a.play().catch(function(){ URL.revokeObjectURL(url); _ttsRelease(); _ttsFlush(); });
      return;
    }
