...
function _kciAnimMiniChain(canvas, ipObj, csInfo, surInfo){
  ...
  var _stCols={RECON:KC_PALETTE.RECON.color,  SCAN:KC_PALETTE.SCAN.color,  EXPLOIT:KC_PALETTE.EXPLOIT.color,  BRUTE:KC_PALETTE.BRUTE.color,  BLOCKED:KC_PALETTE.BLOCKED.color};
  var _stRgbs={RECON:KC_PALETTE.RECON.rgb,    SCAN:KC_PALETTE.SCAN.rgb,    EXPLOIT:KC_PALETTE.EXPLOIT.rgb,    BRUTE:KC_PALETTE.BRUTE.rgb,    BLOCKED:KC_PALETTE.BLOCKED.rgb};
  var _stIcons=['◎','⌖','◈','⊗','⬡'];
