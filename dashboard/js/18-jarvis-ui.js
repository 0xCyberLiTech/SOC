...
function fetchSecStat(){
  ...
  fetch(JV_URL+'/api/security',{signal:AbortSignal.timeout(5000)})
    ...
    .catch(function(e){ if(location.hostname==='localhost')console.warn('[JARVIS] fetchSecStat failed:',e); });
}
...
window._secClear = function(){
  fetch(JV_URL+'/api/security/clear',{method:'POST',signal:AbortSignal.timeout(5000)})
    ...
    .catch(function(e){ if(location.hostname==='localhost')console.warn('[JARVIS] security/clear failed:',e); });
};
...
function fetchSocActions(){
  ...
  fetch(JV_URL+'/api/soc/actions',{signal:AbortSignal.timeout(5000)})
    ...
    .catch(function(e){ if(location.hostname==='localhost')console.warn('[JARVIS] fetchSocActions failed:',e); });
}
...
function _drawBanSpark(acts){
  ...
  bans.forEach(function(a){
    ...
    var ts=0;
    if(a.ts){ try{ ts=new Date(a.ts.replace(' ','T')).getTime(); }catch(e){if(location.hostname==='localhost')console.error('[SOC]',e);} }
...
window._proClear = function(){
  fetch(JV_URL+'/api/soc/actions/clear',{method:'POST',signal:AbortSignal.timeout(5000)})
    ...
    .catch(function(e){ if(location.hostname==='localhost')console.warn('[JARVIS] soc/actions/clear failed:',e); });
};
...
function _saveSnaps(arr){
  try{ localStorage.setItem(_LS_KEYS.JV_FW_SNAPS,JSON.stringify(arr)); }catch(e){if(location.hostname==='localhost')console.error('[SOC]',e);}
}
