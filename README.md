...
**0xCyberLiTech SOC** est un système de supervision sécurité homelab autonome protégeant deux sites web (`clt` et `pa85`) via une VM nginx (`srv-ngix`) faisant office de reverse proxy, WAF et collecteur de logs centraux.
...
- **Sources log centralisées** : 5 hôtes (clt, pa85, pve, routeur GT-BE98, srv-ngix)
...
| clt | <CLT-IP> | Backend Apache · site CLT |
| pa85 | <PA85-IP> | Backend Apache · site PA85 |
