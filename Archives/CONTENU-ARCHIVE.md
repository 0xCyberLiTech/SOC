...
| `cron.d/clt-cve-fetch` | CVE fetch 3x/jour | ✅ |
| `cron.d/clt-threat-fetch` | Threat fetch 03h00 | ✅ |
...
| `id_clt_sync` + `.pub` | `/root/.ssh/id_clt_sync` (connexion clt) | ✅ ⚠️ clé privée |
| `id_pa85_sync` + `.pub` | `/root/.ssh/id_pa85_sync` (connexion pa85) | ✅ ⚠️ clé privée |
...
| `ssh/id_clt_sync` + autres | 🔴 Élevée | Clés SSH privées (sync vers VMs) |
